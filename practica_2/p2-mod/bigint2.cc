 ...
 * @param number_x
 */
BigInt<2, bool>::BigInt(long number_x) {
 ...
 * @param digits
 */
BigInt<2, bool>::BigInt(std::vector<bool> digits) { this->digits = digits; }

/**
 * @brief Construct a new Big Int< 2>:: Big Int object from another BigInt<2, bool>
 *
 * @param number_x
 */
BigInt<2, bool>::BigInt(const BigInt<2, bool> &number_x) { digits = number_x.digits; }
 ...
 * @param number_x
 */
BigInt<2, bool>::BigInt(std::string number_x) {
...
/// Revisar/-----
BigInt<2, bool>::BigInt(const std::vector<char> &digits_aux,const int &sign ){
 ...
 * @return false
 */
bool BigInt<2, bool>::operator[](size_t n) const { return digits[n]; }
 ...
 * @return size_t
 */
size_t BigInt<2, bool>::size() const { return digits.size(); }

/**
 * @brief Operator = to assign a BigInt<2, bool> to another BigInt<2, bool>
 *
 * @param other
 * @return BigInt<2, bool>
 */
BigInt<2, bool> BigInt<2, bool>::operator=(const BigInt<2, bool> &other) {
  digits = other.digits;
  return *this;
}
 ...
 * @return std::string
 */
std::string BigInt<2, bool>::to_string() const {
  std::string number_x;
 ...
 * @return size_t
 */
std::vector<bool> BigInt<2, bool>::GetDigits() const { return digits; }
 ...
 * @return BigInt<2, bool>
 */
BigInt<2, bool> BigInt<2, bool>::SetDigits(std::vector<bool> digits) {
  this->digits = digits;
  return *this;
}

/**
 * @brief Compare two BigInt<2, bool> numbers and return true if they are equal
 *
 * @param other
 * @return true
 * @return false
 */
bool operator==(const BigInt<2, bool> &first, const BigInt<2, bool> &other) {
  // If signs are different return false
  
  BigInt<2, bool> number_x;
  BigInt<2, bool> number_y;
...
/**
 * @brief Compare two BigInt<2, bool> numbers and return true if they are not equal
 *
 * @param other
 * @return true
 * @return false
 */
bool BigInt<2, bool>::operator!=(const BigInt<2, bool> &other) const {
  return !(*this == other);
}

/**
 * @brief Compare two BigInt<2, bool> numbers and return true if this is greater than
 * other
 *
 * @param other
 * @return true
...
/**
 * @brief Compare two BigInt<2, bool> numbers and return true if this is less than
 * other
 *
 * @param other
 * @return true
...
/**
 * @brief Compare two BigInt<2, bool> numbers and return true if this is greater or
 * equal than other
 *
 * @param other
 * @return true
...
/**
 * @brief Compare two BigInt<2, bool> numbers and return true if this is less or equal
 * than other
 *
 * @param other
 * @return true
...
void BigInt<2, bool>::operator<<(size_t n) {
  std::vector<bool> aux;
...
/**
 * @brief Overload the operator + to add two BigInt<2, bool>
 *
 * @param other
 * @return BigInt<2, bool>
 */
BigInt<2, bool> operator+(const BigInt<2, bool> &first, const BigInt<2, bool> &other) {
  ...
  BigInt<2, bool> result(aux);
  return result;
}

BigInt<2, bool> BigInt<2, bool>::sum_overflow(const BigInt<2, bool> &first,
                                  const BigInt<2, bool> &other) const {
  std::vector<bool> number_x = first.digits;
  std::vector<bool> number_y = other.digits;
  bool carry = false;
  bool sum;
...
/**
 * @brief Overload the operator - to substract two BigInt<2, bool>
 *
 * @param other
 * @return BigInt<2, bool>
 */
BigInt<2, bool> BigInt<2, bool>::operator-(const BigInt<2, bool> &other) const {
  BigInt<2, bool> number_y = other.ConvertToTwosComplement();
  BigInt<2, bool> result = *this + number_y;
  return result;
}

/**
 * @brief Overload the operator << to shift left a BigInt<2, bool>
 *
 * @param other
 */
void BigInt<2, bool>::operator>>(BigInt<2, bool> &other) {
...
/**
 * @brief Overload the operator >> to shift right a BigInt<2, bool>
 *
 * @param other
 */
void BigInt<2, bool>::operator<<(BigInt<2, bool> &other) {
...
/**
 * @brief Insert a by begining a BigInt<2, bool>
 * example 0001.push_back(1) = 10001
 *
 * @param digit
 */
void BigInt<2, bool>::push_back(bool digit) { digits.push_back(digit); }

/**
 * @brief Overload the operator * to multiply two BigInt<2, bool>
 *
 * @param other
 * @return BigInt<2, bool>
 */
BigInt<2, bool> BigInt<2, bool>::operator*(const BigInt<2, bool> &other) const {
  ...
  BigInt<2, bool> number_M = *this;
  BigInt<2, bool> number_Q = other;
  ...
  return BigInt<2, bool>(result);
}

/**
 * @brief Overload the operator / to divide two BigInt<2, bool>
 *
 * @param other
 * @return BigInt<2, bool>
 */
BigInt<2, bool> operator/(const BigInt<2, bool> &first, const BigInt<2, bool> &other) {
  // same size
  BigInt<2, bool> number_f = first;
  BigInt<2, bool> number_s = other;
  ...
  BigInt<2, bool> number_Q_r(result);
...
/**
 * @brief Overload the operator % to get the remainder of two BigInt<2, bool>
 *
 * @param other
 * @return BigInt<2, bool>
 */
BigInt<2, bool> &BigInt<2, bool>::operator++() {
  *this = *this + BigInt<2, bool>("01");
  return *this;
}

/**
 * @brief Overload the operator ++ to increment a BigInt<2, bool>
 *
 * @return BigInt<2, bool>
 */
BigInt<2, bool> BigInt<2, bool>::operator++(int) {
  BigInt<2, bool> aux = *this;
  (*this) = (*this) + BigInt<2, bool>("01");
  return aux;
}

/**
 * @brief Overload the operator -- to decrement a BigInt<2, bool>
 *
 * @return BigInt<2, bool>&
 */
BigInt<2, bool> &BigInt<2, bool>::operator--() {
 ...
 * @return BigInt<2, bool>
 */
BigInt<2, bool> BigInt<2, bool>::FillSign(size_t n) const {
...
/**
 * @brief Return the absolute value of a BigInt<2, bool>
 *
 * @return BigInt<2, bool>
 */
BigInt<2, bool> BigInt<2, bool>::Abs() const {
 ...
 * @return BigInt<2, bool>
 */
BigInt<2, bool> BigInt<2, bool>::ConvertToTwosComplement() const {
  std::vector<bool> aux;
  bool flag = false;
...
/**
 * @brief Calculate the module of two BigInt<2, bool>
 *
 * @param other
 * @return BigInt<2, bool>
 */
BigInt<2, bool> BigInt<2, bool>::operator%(const BigInt<2, bool> &other) const {
  BigInt<2, bool> number_f = *this;
  BigInt<2, bool> number_s = other;
  if (number_f.digits.size() > number_s.digits.size()) {
    number_s = other.FillSign(number_f.digits.size() - number_s.digits.size());
  } else if (number_f.digits.size() < number_s.digits.size()) {
 ...
 * @return BigInt<2, bool> 
 */
BigInt<2, bool> pow(const BigInt<2, bool> &first, const BigInt<2, bool> &other) {
  static  BigInt<2, bool> zero ("00");
  static  BigInt<2, bool> one ("01");
  static  BigInt<2, bool> two ("010");
  if (other < zero) {
    return zero;
  }
  if (other == zero) {
    ...
    BigInt<2, bool> half = pow(first, other / two);
    return half * half;
  } else {
    BigInt<2, bool> half = pow(first, (other - one) / two);
    return half * half * first;
  }
}

/**
 * @brief Operator ^ for BigInt<2, bool> do pow operation
 * 
 * @param other 
 * @return BigInt<2, bool> 
 */
 ...
 * @return BigInt<2, bool> 
 */
BigInt<2, bool> BigInt<2, bool>::factorial() const {
  BigInt<2, bool> result("01");
  BigInt<2, bool> one("01");
  BigInt<2, bool> zero("00");
  BigInt<2, bool> i("01");
  while (i <= *this) {
    result = result * i;
    i = i + one;
...
/**
 * @brief Operator ! for BigInt<2, bool> do factorial operation
 * 
 * @return BigInt<2, bool> 
 */
...
/**
 * @brief Convert a BigInt<2, bool> to a BigInt<base>
 * 
 * @tparam base 
 * @return BigInt<base> 
 */
template <size_t base>
BigInt<2, bool>::operator BigInt<base>() const{
  BigInt<base> result("0");
  BigInt<2, bool> number = this->Abs();
  BigInt<2, bool> zero2("00");
  if (number == zero2) {
    return result;
  }
  BigInt<base> expo("0");
...
/**
 * @brief Overload the operator << to print a BigInt<2, bool> object
 *
 * @param os
 * @param number_x
 * @return std::ostream&
 */
std::ostream &operator<<(std::ostream &os, const BigInt<2, bool> &number_x) {
